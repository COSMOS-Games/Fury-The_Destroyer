...
(function (scenes) {
    ...
    (function (State) {
        ...
        State[State["INSTRUCTION_CLEAN"] = 5] = "INSTRUCTION_CLEAN";
        State[State["FIRST"] = 6] = "FIRST";
        State[State["STAGE_CLEANED"] = 7] = "STAGE_CLEANED";
        State[State["SECOND"] = 8] = "SECOND";
        State[State["STAGE_CLEANEDAGAIN"] = 9] = "STAGE_CLEANEDAGAIN";
        State[State["THIRD"] = 10] = "THIRD";
        State[State["END"] = 11] = "END";
        State[State["NUM_OF_SCENES"] = 12] = "NUM_OF_SCENES";
