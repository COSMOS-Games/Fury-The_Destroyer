...
var scenes;
(function (scenes) {
    class StageCleanedAgain extends objects.Scene {
        // PUBLIC PROPERTIES
        // CONTRUCTOR
        constructor() {
            super();
            ...
            let description = "In next level, more randomly generated MINEs in map!  \n\nBe careful!  \n\n" +
    ...
    scenes.StageCleanedAgain = StageCleanedAgain;
})(scenes || (scenes = {}));
//# sourceMappingURL=StageCleanedAgain.js.map