...
let Game = (function () {
  ...
  let MoveInstruction: scenes.MoveInstruction;
  let ShootInstruction: scenes.ShootInstruction;
  ...
  let atlas: createjs.SpriteSheet;
  let assetManifest = [
    // images
    { id: "atlas", src: "./Assets/sprites/atlas.png" }, // from
